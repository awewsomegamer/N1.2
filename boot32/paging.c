...
void create_pml4() {
	...
	printf("0x%X 0x%X 0x%X 0x%X\n", fb_pml4_index, fb_pdp_index, fb_pd_index, (_VESA_VIDEO_MODE_INFO.framebuffer) + _VESA_VIDEO_MODE_INFO.width * _VESA_VIDEO_MODE_INFO.height * (_VESA_VIDEO_MODE_INFO.bpp / 8));
